...
run:
(.venv) mycroft@localhost:~$ sudo python3 /home/mycroft/Debug/pygameTest.py
...
# subprocess.getoutput('sudo python3 /home/mycroft/Debug/precise_test.py &')
...
class MycroftPCBATest:
    ...
    def startupProcedure(self):
        ...
        self.printPassFail()
        result = subprocess.getoutput("sudo /opt/mycroft/start-xmos-kevin.sh &")
    ...
    def programATtiny(self):
        ...
        result = subprocess.getoutput(
            "sudo /home/mycroft/Debug/bin/arduino-cli burn-bootloader -b megaTinyCore:megaavr:atxy4 --programmer atmelice_updi"
        )
        print(result)
        ...
        result = subprocess.getoutput(
            "sudo /home/mycroft/Debug/bin/arduino-cli upload --fqbn megaTinyCore:megaavr:atxy4 --programmer atmelice_updi /home/mycroft/Debug/mark2_attiny1614.ino/mark2_attiny1614.ino"
        )
        print(result)
    ...
    def compileArduino(self):
        if self.arduinoCompiled == False:
            result = subprocess.getoutput(
                "sudo -u mycroft /home/mycroft/Debug/bin/arduino-cli compile --fqbn megaTinyCore:megaavr:atxy4 /home/mycroft/Debug/mark2_attiny1614.ino/mark2_attiny1614.ino"
            )
            print(result)
    ...
    def testSpeakers(self):
        ...
        # play audio
        result = subprocess.getoutput("aplay /home/mycroft/Debug/heymycroft-kevin1.wav")
        print(result)
        sleep(1.5)
        tail = tailer.tail(open("/home/mycroft/Debug/heymycroft.log"), 1)
    ...
    def printPassFail(self):
        ...
        print(
            "Serial Num   : %s %s" % (self.pf(self.SerialNum_Pass), self.SerialNumLast)
        )
    ...
    def sendSerialNum(self):
        if len(self.SerialNum) >= 8:
            result = subprocess.getoutput(
                "i2cset -y 1 0x04 0xE1  0x%s" % self.SerialNum[0:2]
            )
            result = subprocess.getoutput(
                "i2cset -y 1 0x04 0xE2  0x%s" % self.SerialNum[2:4]
            )
            result = subprocess.getoutput(
                "i2cset -y 1 0x04 0xE3  0x%s" % self.SerialNum[4:6]
            )
            result = subprocess.getoutput(
                "i2cset -y 1 0x04 0xE4  0x%s" % self.SerialNum[6:8]
            )
